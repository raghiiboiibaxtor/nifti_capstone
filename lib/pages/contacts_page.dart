          ...
          child: Column(children: [
            const SizedBox(height: 10,),
             ButtonComponent(
              ...
              text: 'Bottom Sheet',
              onTap: () {
                displayModalBottomSheet(context,  '${friend['firstName']}' ' ${friend['lastName']}', '${friend['bio']}', '${friend['pronouns']}', '${friend['industry']}', '${friend['city/town']}', '${friend['role']}', '${friend['company']}', '${friend['yearsWorked']}',);
              },
             ),
             // space between
